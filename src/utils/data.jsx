    ...
    workexp: [
        {
            ...
            summary: "Working with Babs Carryer in Entrepreneurship and Innovation in Technology (14815). Mentored students on their “Apprentice Project” and “My Startup” projects."
        },
        {
            photoLink: {
                src: zup,
            ...
            summary: "Led the development of the initial version of ZUP payments. Created the swipe2.0 protcol for faster transfer of information within smartphone (Android and iOS)."
        },
        {
            photoLink: {
                src: zup,
            ...
            summary: "Scaled the Visitor Management System and Guest management Systems for 50% shorter query time. Added analytics dashboard to judge the trends and frequency of guests. Showcased our offerings in Nepal"
        },
        {
            photoLink: {
                src: zup,
            ...
            summary: "Developed multiple prototypes from the base technology on Android Platform. Created Visitor Management and Guest Management web portals and mobile application. "
        },
        {
            photoLink: {
                src: gaia,
            ...
            summary: "Developed an Android application for a prototype smart scale. Mentored fellow developers on Android applications"
        }
    ],
    ...
    eduexp: [
        {
            ...
            summary: "Pursuing Masters in Software Engineering in School of Computer Science."
        },
        {
            photoLink: {
                src: ipu,
            ...
            summary: "Graduated in first division in Computer Science and Engineering"
        }
    ]
